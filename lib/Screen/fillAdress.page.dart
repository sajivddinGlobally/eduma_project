...
class _FillAddressPageState extends ConsumerState<FillAddressPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final isMainLoading = addres.isLoading || calculateDynamicState.isLoading;
    return Scaffold(
                ...
                children: [
                  addres.when(
                    data: (data) {
                      ...
                      return calculateDynamicState.when(
                        data: (dataCalculate) {
                          return Padding(
                            padding: EdgeInsets.all(16.0),
                            child: Column(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 15.w),
                                      Text(
                                        "Your cart weight is: ${dataCalculate?.weight ?? 0}kg",
                                        style: TextStyle(
                                          fontSize: 16.sp,
                                      ...
                                      ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          await ref
                                              ...
                                              .appluCupon(
                                                cuponCode: couponController.text
                                                    .trim(),
                                                context: context,
                                              );
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  "Packing, Forwarding & Courier - ${data.billing!.state}",
                                                  style: GoogleFonts.poppins(
                                                    fontSize: 13.sp,
                                                  ),
                                                ),
