...
class _AddressFormPageState extends ConsumerState<AddressFormPage> {
  ...
  Future<void> _loadCurrentAddress() async {
    try {
      ...
      if (data.hasBilling && data.billing != null) {
        ...
        countryController.text = billing.country ?? 'India';
        ...
        if ((billing.state ?? '').isNotEmpty) {
          await ref
              ...
              .calculateDyanmicAmmount(stateName: billing.state!);
        }
      }
    } catch (e, st) {
      log("Load Address Error: $e");
      log("StackTrace: $st");
    }
  }
                      ...
                      try {
                        final body = EditAddressBodyModel(
                          billing: Ing(
                            ...
                            city: townCityController.text.trim(),
