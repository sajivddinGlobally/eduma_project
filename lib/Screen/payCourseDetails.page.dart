...
class PayCourseDetailsPage extends StatefulWidget {
  const PayCourseDetailsPage({super.key});

  @override
  State<PayCourseDetailsPage> createState() => _PayCourseDetailsPageState();
}

class _PayCourseDetailsPageState extends State<PayCourseDetailsPage> {
  @override
