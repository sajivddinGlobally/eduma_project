...
class CoursePage extends ConsumerStatefulWidget {
  ...
  const CoursePage({super.key, required this.categoryId});
...
class _CoursePageState extends ConsumerState<CoursePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final categoryByIDProvider = ref.watch(
      categoryByIdController(widget.categoryId.toString()),
    );
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    snap.courses[index].title.toString(),
                                    style: GoogleFonts.roboto(
                                      fontSize: 18.sp,
                                      fontWeight: FontWeight.w500,
...
//                     CupertinoPageRoute(
//                       builder: (context) =>
//                           CourseDetailsPage(id: widget.data.enrollmentId.toString()),
//                     ),
//                   );
//                 },
//                 child: ClipRRect(
...
//                     // courseList[index]['paid']
//                     //     .toString(),
//                     widget.data.pricing.isFree.toString(),
//                     style: GoogleFonts.roboto(
//                       fontSize: 18.sp,
//                       fontWeight: FontWeight.w500,
//                       color: Colors.white,
...
//               Text(
//                 //courseList[index]['time'].toString(),
//                 widget.data.enrollmentInfo.enrollmentDate.timeZoneName+widget.data.enrollmentInfo.enrollmentDate.hour.toString(),
//                 style: GoogleFonts.roboto(
//                   fontSize: 16.sp,
//                   fontWeight: FontWeight.w500,
//                   color: Color(0xFF747272),
