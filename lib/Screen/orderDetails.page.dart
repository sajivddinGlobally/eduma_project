import 'package:eduma_app/data/Controller/orderDetailsController.dart';
...
class _OrderDetailsPageState extends ConsumerState<OrderDetailsPage> {
  ...
  Widget build(BuildContext context) {
    final orderDetaislProvider = ref.watch(
      orderDetailsController(widget.id.toString()),
    );
    return Scaffold(
