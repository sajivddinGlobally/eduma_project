...
class OrderListModel {
  ...
  OrderListModel({
    ...
    this.amsPaymentMethodTitle,
    this.orderCheckoutPaymentUrl,
  ...
  factory OrderListModel.fromJson(Map<String, dynamic> json) => OrderListModel(
    ...
    number: json["number"],
    metaData: List<OrderListModelMetaDatum>.from(
      json["meta_data"].map((x) => OrderListModelMetaDatum.fromJson(x)),
    ),
    ...
    featuredImageSrc: json["featured_image_src"].toString(),
    // amsAcf: List<dynamic>.from(json["ams_acf"].map((x) => x)),
    amsAcf: (json["ams_acf"] as List?)?.map((x) => x).toList() ?? [],
    amsPaymentMethodTitle: json["ams_payment_method_title"].toString(),
    orderCheckoutPaymentUrl: json["order_checkout_payment_url"].toString(),
...
class Links {
  ...
  factory Links.fromJson(Map<String, dynamic> json) => Links(
    ...
    emailTemplates: List<EmailTemplate>.from(
      json["email_templates"].map((x) => EmailTemplate.fromJson(x)),
    ),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "email_templates": List<dynamic>.from(
      emailTemplates.map((x) => x.toJson()),
    ),
...
class EmailTemplate {
  ...
  EmailTemplate({required this.embeddable, required this.href});

  factory EmailTemplate.fromJson(Map<String, dynamic> json) =>
      EmailTemplate(embeddable: json["embeddable"], href: json["href"]);
...
class OrderListModelMetaDatum {
  ...
  factory OrderListModelMetaDatum.fromJson(Map<String, dynamic> json) =>
      OrderListModelMetaDatum(
        id: json["id"],
        key: json["key"],
        value: json["value"],
...
//     String cartHash;
//     String number;
//     List<OrdersListModelMetaDatum> metaData;
//     List<LineItem> lineItems;
//     List<dynamic> taxLines;
...
//         cartHash: json["cart_hash"],
//         number: json["number"],
//         metaData: List<OrdersListModelMetaDatum>.from(json["meta_data"].map((x) => OrdersListModelMetaDatum.fromJson(x))),
...
// class OrdersListModelMetaDatum {
//     int id;
//     String key;
//     String value;

//     OrdersListModelMetaDatum({
//         required this.id,
//         required this.key,
//         required this.value,
//     });

//     factory OrdersListModelMetaDatum.fromJson(Map<String, dynamic> json) => OrdersListModelMetaDatum(
//         id: json["id"],
//         key: json["key"],
//         value: json["value"],
//     );
