...
List<PopularCourseModel> popularCourseModelFromJson(String str) => List<PopularCourseModel>.from(json.decode(str).map((x) => PopularCourseModel.fromJson(x)));

String popularCourseModelToJson(List<PopularCourseModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
