...
//     wpStatisticsWordsCount: List<String>.from(
//       (json["wp_statistics_words_count"] ?? []).map((x) => x.toString()),
//     ),
//     thumbnailId: json["_thumbnail_id"] == null
//         ? []
//         : List<String>.from(
//             (json["_thumbnail_id"] ?? []).map((x) => x.toString()),
//           ),
//     video: json["_video"] == null
//         ? []
//         : List<String>.from((json["_video"] ?? []).map((x) => x.toString())),
//   );

//   Map<String, dynamic> toJson() => {
//     "wp_statistics_words_count": List<dynamic>.from(
//       wpStatisticsWordsCount.map((x) => x),
//     ),
